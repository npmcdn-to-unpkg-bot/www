...
class __TwigTemplate_8cbda8763222ea133d23e7ec6e421152378cbb1e4ea08068ce9e73ca852a5351 extends Twig_Template
{
...
/* 	                {% if particle.readmore %}<a href="{{ particle.link|e }}" class="button {{ particle.readmoreclass|e }}">{% if particle.icon %}<i class="{{ particle.icon|e }}"></i>{% endif %}{{ particle.readmore|raw }}</a>{% endif %}*/
/* 	            </div>*/
/* 	        </div>    */
/* 	    </div> */
/* */
