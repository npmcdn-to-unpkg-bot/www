...
class __TwigTemplate_12082909221c99b64f38113f8dd7fc6dc090ccc0aa7337b5276875e8de0dfc7f extends Twig_Template
{
...
\t\t\t\t\t        ";
            ...
            if ($this->getAttribute($context["gridcontentitem"], "link", array())) {
                echo "<a target=\"";
                echo twig_escape_filter($this->env, (($this->getAttribute($context["gridcontentitem"], "linktarget", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["gridcontentitem"], "linktarget", array()), "_self")) : ("_self")));
                echo "\" href=\"";
...
";
    ...
    {
        return array (  149 => 29,  128 => 25,  119 => 24,  112 => 23,  105 => 22,  99 => 21,  95 => 19,  87 => 18,  82 => 16,  79 => 15,  75 => 14,  71 => 13,  68 => 12,  58 => 10,  55 => 9,  53 => 8,  45 => 7,  36 => 5,  31 => 4,  28 => 3,  11 => 1,);
    }
}
...
/* 					        {% if gridcontentitem.link %}<a target="{{ gridcontentitem.linktarget|default('_self')|e }}" href="{{ gridcontentitem.link|e }}" class="button {{ gridcontentitem.linkclass|e }}">{{ gridcontentitem.linktext|raw }}</a>{% endif %} 				    			*/
/* 			    		</div>	*/
/* 			    	</div>*/
/* 			    </div>	*/
/* 			{% endfor %} */
