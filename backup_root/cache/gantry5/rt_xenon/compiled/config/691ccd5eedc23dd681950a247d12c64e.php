...
return [
    ...
    'timestamp' => 1458640982,
    'checksum' => '46338c688f206db5dfa6a4c155564c4a',
    'files' => [
        'templates/rt_xenon/config/_error' => [
            'page/body' => [
                'file' => 'templates/rt_xenon/config/_error/page/body.yaml',
                'modified' => 1453474406
            ]
        ],
        'templates/rt_xenon/config/default' => [
            'menu' => [
                'file' => 'templates/rt_xenon/config/default/menu.yaml',
                'modified' => 1453474406
            ],
            'page/assets' => [
