...
<table cellpadding="0" cellspacing="0" style="width:100%;max-width:620px;border:1px solid #ff7200;padding:0 10px 10px;font-family:Gotham,&#39;Helvetica Neue&#39;,Helvetica,Arial,sans-serif;font-size:13px;line-height:25px">
  ...
  <tr>
    ...
    <td align="left"><b>'.$membership_type.'</b></td>
  </tr>
  <tr>
    <td align="left"><b>First Name</b></td>
    <td align="left">'.$membership_details->field_first_name['und'][0]['value'].'</td>
  </tr>
  <tr>
    <td align="left"><b>Last Name</b></td>
    <td align="left">'.$membership_details->field_last_name['und'][0]['value'].'</td>
  </tr>
  <tr>
    <td align="left"><b>Email Address</b></td>
    <td align="left"><a href="mailto:'.$membership_details->field_email_address['und'][0]['value'].'" target="_blank">'.$membership_details->field_email_address['und'][0]['value'].'</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><b>$'.number_format($membership_details->field_amount_paid['und'][0]['value'],2).'</b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" colspan="2">To upgrade your membership visit : <a href="'.$base_url.'/member/login/" target="_blank">'.$base_url.'/member/login/</a></td>
  </tr>
  <tr>
