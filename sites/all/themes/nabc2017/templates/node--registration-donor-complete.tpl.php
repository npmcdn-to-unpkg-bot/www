...
<?php print getFormErrors();?>         
                ...
                <div class="heading-registration"><h4><span class="blacktext">Complete Donor Registration to</span> #iNDULGE <span class="blacktext">@ NABC2017</span></h4></div>
                    <div class="col-sm-12 text-right"><?php /*<a href="<?php print url('book-hotel'); ?>">Book Hotel &nbsp;<i class="fa fa-bed"></i></a>*/?> <a href="<?php print url('member/logout'); ?>">Logout &nbsp;<i class="fa fa-lock"></i></a></div>
                    <form class="register_frm form-horizontal" enctype="multipart/form-data" action="<?php print $form['#action'];?>" method="<?php print $form['#method'];?>" id="<?php print $form['#id'];?>" accept-charset="UTF-8">
                            ...
                            <div class="col-sm-12 center-xs wow fadeInLeft animated">
                            	<h5 class="form-heading" id="step1-form-heading">Member Profile : Donor</h5>
                            </div>
...
function reg_goto(step){
		...
		if(jQuery('#core-overrides-membership-registration-donor-saved-form').valid() && check_additional_members && error_additional_member_fields){
...
jQuery(document).ready(function(event){
		...
		jQuery("#core-overrides-membership-registration-donor-form").on("submit", function(){
            update_total_price();
         });	

		jQuery("#core-overrides-membership-registration-donor-form").validate({
					errorElement: "em",
					...
					messages: {
						...
						field_address: "Please enter address",
