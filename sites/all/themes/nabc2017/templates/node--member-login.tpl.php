...
<div class="regi-bg1"><div id="node-<?php if(isset($node->nid)) { print $node->nid;} ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content clearfix"<?php print $content_attributes; ?>>
    ...
    <li><a href="#tabs-2" id="tab2nav">Saved Profile</a></li>
      ...
      <div class="tab1 col-sm-12 center-xs" id="tabs-1">
      	<div class="col-sm-12 center-xs wow fadeInLeft animated">
             <div class="form-group forgot_text" style="color:#FF0000; font-size:14px;">
                 <b style="color:#000000;">Important Note:</b> For membership upgradation, please check back after July, 7th 2016 . We are upgrading the flow for better performance. You can still login and check your membership details.
             </div>
         </div>
      	<div class="col-sm-6 center-xs wow fadeInLeft animated">
        	<div class="form-group">
            	<?php print render($form['field_email_address']);?>
            </div>
        </div>   
        <div class="col-sm-6 center-xs wow fadeInLeft animated">
            <div class="form-group">
            	<?php print render($form['field_membership_number']);?>
            </div>
      ...
      <div class="col-sm-6 center-xs wow fadeInLeft animated">
            <div class="form-group">
                <?php print render($form['field_email_address_1']);?>
            </div>
        </div>   
        <div class="col-sm-6 center-xs wow fadeInLeft animated">
            <div class="form-group">
                <?php print render($form['field_membership_token']);?>
            </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(event){
        ...
        jQuery("#core_overrides_paid_membership_form").validate({
                    errorElement: "em",
                    ...
                    rules: {
                        field_membership_number: "required",
                        field_email_address: {
                            required: true,
                            email: true
                        },  
                        field_membership_token: "required",
                        field_email_address_1: {
                            required: true,
                            email: true
                        }, 
                    },
                    messages: {
                         field_email_address: "Please enter a valid email address",
                         field_membership_number: "Please enter membership number",
                         field_email_address_1: "Please enter a valid email address",
                         field_membership_token: "Please enter login token",
                    }
                });
                
				var request_url = '<?php echo $arg1.'/'.$arg2.'/'.$arg3;?>';
				if(request_url == 'member/login/saved') {
                jQuery( "#tabs" ).tabs({
                  active: 1
                });
                } else {    
