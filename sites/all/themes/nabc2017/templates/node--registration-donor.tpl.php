...
<?php print getFormErrors();?>         
                ...
                <div class="regi-bg1 text-center">
                <div class="reg_form_container col-sm-12 center-xs">
                <div class="heading-registration"><h4><span class="blacktext">Donor Registration to</span> #iNDULGE <span class="blacktext">@ NABC2017</span></h4></div>
                    <form class="register_frm form-horizontal" enctype="multipart/form-data" action="<?php print $form['#action'];?>" method="<?php print $form['#method'];?>" id="<?php print $form['#id'];?>" accept-charset="UTF-8">
                           ...
                           <div class="col-sm-4 center-xs wow fadeInLeft animated"> <div class="form-group">
                            ...
                            <div class="col-sm-6 col-md-offset-3 center-xs wow fadeInLeft animated"><div class="form-group">
...
function reg_goto(step){
		...
		if(jQuery('#core-overrides-membership-registration-donor-form').valid() && check_additional_members && error_additional_member_fields){
