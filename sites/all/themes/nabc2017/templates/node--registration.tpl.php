...
<?php
 global $base_url;
 //echo "<pre>"; print_r(node_load(87)); echo "</pre>"; die();
 $paypal_mode = variable_get('paypal_mode'); // sandbox or live
?>
<!--<div class="row row-no-gutter container-wide">
	<img class="img-responsive" src="<?php print $base_url.'/'.path_to_theme();?>/images/regi-img.jpg" alt="">
</div>   -->   
                ...
                <div class="heading-registration"><h4><span class="blacktext">Register to </span>#iNDULGE <span class="blacktext">@ NABC2017</span></h4></div>
                    <form class="register_frm form-horizontal" enctype="multipart/form-data" action="<?php print $form['#action'];?>" method="<?php print $form['#method'];?>" id="<?php print $form['#id'];?>" accept-charset="UTF-8">
                            ...
                            <div class="col-sm-12 center-xs wow fadeInLeft animated">
                                ...
                                <span>NOTE: User accepts responsibility of inserting correct information. NABC 2017 cannot process with wrong information.</span>
                                </h5>
                            </div>     
                            <div class="col-sm-12 center-xs wow fadeInLeft animated">
                            ...
                            <div class="col-sm-6 center-xs wow fadeInLeft animated"><div class="form-group required">
                            <?php print render($form['field_member_title']);?>
                            </div></div>
                            <div class="col-sm-4 center-xs wow fadeInLeft animated"><div class="form-group required">
                            <?php print render($form['field_first_name']);?>
                            </div></div>
                            <div class="col-sm-4 center-xs wow fadeInLeft animated"><div class="form-group">
                            ...
                            <?php /*<div class="col-sm-6 center-xs wow fadeInLeft animated"><div class="form-group required">
                           ...
                           <div class="col-sm-4 center-xs wow fadeInLeft animated"> <div class="form-group">
                            ...
                            <div class="col-sm-12 col-sm-offset-5 wow fadeInLeft animated"><div class="form-group"> 
                                    ...
                                    <input type="button" class="btn btn-default" name="gotobtn1" id="gotobtn1" value="Proceed">
                                </div>
                            </div>
                            </div>
                                ...
                                <div class="col-sm-12 center-xs wow fadeInLeft animated">
                                    <div class="form-group">                 
                                        <div class="form-item total_price">
                                            ...
                                            <span class="field_data" id="field_total_price_data">$0.00</span>
                                        </div>                 
                                    </div>
                                </div>
                                <div class="form-group">        
...
jQuery(document).ready(function(event){
		...
		jQuery("#core-overrides-membership-registration-form--2").on("submit", function(){
            update_total_price();
         });
      
        jQuery("#core-overrides-membership-registration-form--2").validate({
                    errorElement: "em",
    ...
    jQuery("#backbtn4").on("click", function(event){
		reg_goto('step1');
    ...
    jQuery('#gotobtn1').on("click touchend",function(event){
		 reg_goto('step2');
         event.preventDefault();
         
    });
    
    jQuery('#field_membership_type').on("change touchend",function(){
        update_total_price();
    });
...
function reg_goto(step){
		...
		if(jQuery('#core-overrides-membership-registration-form--2').valid() && check_additional_members && error_additional_member_fields){
...
function add_remove_element_on_additional_member_info(){
	for(i=1; i<=6; i++){
		jQuery('#edit-field-additional-members-member-'+i+'--2').append('<div class="removebtn"><span class="glyphicon glyphicon-remove" onclick="javascript:remove_add_member_info('+i+');"></span></div>');
		jQuery('#edit-field-additional-members-member-'+i+'--2').hide();
	}
}

function remove_add_member_info(id){
	jQuery('#edit-field-additional-members-member-'+id+'--2').hide();
...
var add_member_info_incrementor = 1;
function add_more_member_info(){
	//alert('Clicked');
	var last_visible_element_id = jQuery('#edit-field-additional-members--2 fieldset:visible:last').attr('id');
	...
	var last_visible_number = last_visible_element_arr[parseInt(last_visible_element_arr_size)-2];
	var last_visible_element_arr = last_visible_number.split('-');
	var last_visible_element_arr_size = last_visible_element_arr.length;
	...
	jQuery('#edit-field-additional-members-member-'+add_member_info_incrementor+'--2').show();
	}
}
